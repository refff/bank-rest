    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/admin/cardStatusRequest").hasAuthority("ROLE_ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/admin/deleteCard").hasAuthority("ROLE_ADMIN")
                        .requestMatchers(HttpMethod.GET, "/admin/allBlockRequests").hasAuthority("ROLE_ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/admin/blockAllWaitedCards").hasAuthority("ROLE_ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/client/blockCardRequest").hasAuthority("ROLE_USER")
